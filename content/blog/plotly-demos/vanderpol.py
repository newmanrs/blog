...
# ODE parameters for Van der Pol oscillator
# Script plots from several initial conditions
# for the animation at once.

# dx/dt = y
# dy/dt = -x + y * (1 - x^2)

#ODE Initial conditions for a list of initial points
z0 = [[0,0],[-2.5,3.5],[2.5,-3.5],[-1,0],[1,0],[0,1],[0,-1]]
Ntraj = len(z0)
t0 = 0

# Integrator steps
Npts = 10*(121)
dt = '0.01'     # str, cast to float later after decimal
                # digits have been extracted.
...
### output
outputfile = 'vanderpol.html'
# Set these to 'cdn' 'cdn' or 'cdn', 'True' if you embed in iframe
# otherwise add the js to your site and set False/False.
...
def vanderpol(t, z):
    """
    Van der Pol dz/dt for ODE integrator
    """
    x, y = z
    dzdt = [
        y,
